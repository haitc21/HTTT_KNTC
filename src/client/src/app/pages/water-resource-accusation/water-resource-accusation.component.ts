...
@Component({
  selector: 'app-water-resource-accusation',
  templateUrl: './water-resource-accusation.component.html',
  styleUrls: ['./water-resource-accusation.component.scss'],
})
export class WaterResourcAccusationComponent implements OnInit {
  blockedPanel = false;
  data: HoSo[] = [];
