...
@Component({
  selector: 'app-land-complaint',
  templateUrl: './land-complaint.component.html',
  styleUrls: ['./land-complaint.component.scss'],
})
export class LandComplaintComponent implements OnInit {
  blockedPanel = false;
  data: HoSo[] = [];
