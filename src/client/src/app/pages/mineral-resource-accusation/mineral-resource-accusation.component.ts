...
@Component({
  selector: 'app-mineral-resource-accusation',
  templateUrl: './mineral-resource-accusation.component.html',
  styleUrls: ['./mineral-resource-accusation.component.scss'],
})
export class MineralResourceAccusationComponent implements OnInit {
  blockedPanel = false;
  data: HoSo[] = [];
