...
@Component({
  selector: 'app-mineral-resource-complaint',
  templateUrl: './mineral-resource-complaint.component.html',
  styleUrls: ['./mineral-resource-complaint.component.scss'],
})
export class MineralResourceComplaintComponent implements OnInit {
  blockedPanel = false;
  data: HoSo[] = [];
