...
@Component({
  selector: 'app-enviromental-complaint',
  templateUrl: './enviromental-complaint.component.html',
  styleUrls: ['./enviromental-complaint.component.scss'],
})
export class EnviromentalComplaintComponent implements OnInit {
  blockedPanel = false;
  data: HoSo[] = [];
