...
public class WebBaseDbMigrationService : ITransientDependency
{
    public ILogger<WebBaseDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IWebBaseDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;
    private readonly IConfiguration _configuration;

    public WebBaseDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IWebBaseDbSchemaMigrator> dbSchemaMigrators,
        ...
        IConfiguration configuration)
    {
        ...
        Logger = NullLogger<WebBaseDbMigrationService>.Instance;
