        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    So_to_BD = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    giai_doan = table.Column<int>(type: "integer", nullable: false),
                    ten_tai_lieu = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    hinh_thuc = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    thoi_gian_ban_hanh = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ngay_nhan = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    thu_tu_but_luc = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    noi_dung_chinh = table.Column<string>(type: "text", nullable: true),
                    file_name = table.Column<string>(type: "character varying(258)", maxLength: 258, nullable: false),
                    ...
                    cong_khai = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tieu_de = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    nguoi_nop_don = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    cccd_cmnd = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ngay_sinh = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    dien_thoai = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    dia_chi_thuong_tru = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    dia_chi_lien_he = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    ma_tinh_tp = table.Column<int>(type: "integer", nullable: false),
                    ma_quan_huyen = table.Column<int>(type: "integer", nullable: false),
                    ma_xa_phuong_tt = table.Column<int>(type: "integer", nullable: false),
                    thoi_gian_tiep_nhan = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    thoi_gian_hen_tra_kq = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    noi_dung_vu_viec = table.Column<string>(type: "text", nullable: false),
                    bo_phan_dang_xl = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    so_thua = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    to_ban_do = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    dien_tich = table.Column<decimal>(type: "numeric", nullable: false),
                    loai_dat = table.Column<int>(type: "integer", nullable: false),
                    dia_chi_thua_dat = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    tinh_thua_dat = table.Column<int>(type: "integer", nullable: false),
                    huyen_thua_dat = table.Column<int>(type: "integer", nullable: false),
                    xa_thua_dat = table.Column<int>(type: "integer", nullable: false),
                    du_lieu_toa_do = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    du_lieu_hinh_hoc = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ghi_chu = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    loai_khieu_nai_1 = table.Column<int>(type: "integer", nullable: true),
                    ngay_khieu_nai_1 = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ngay_tra_kq_1 = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    tham_quyen_1 = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    so_qd_1 = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ket_qua_1 = table.Column<int>(type: "integer", nullable: true),
                    loai_khieu_nai_2 = table.Column<int>(type: "integer", nullable: true),
                    ngay_khieu_nai_2 = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ngay_tra_kq_2 = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    tham_quyen_2 = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    so_qd_2 = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ket_qua_2 = table.Column<int>(type: "integer", nullable: true),
                    ket_qua = table.Column<int>(type: "integer", nullable: true),
                    cong_khai = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    thoi_gian_hen_tra_kq = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    noi_dung_vu_viec = table.Column<string>(type: "text", nullable: false),
                    nguoi_bi_to_cao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    bo_phan_dang_xl = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    so_thua = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    to_ban_do = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    dien_tich = table.Column<decimal>(type: "numeric", nullable: false),
                    ...
                    du_lieu_hinh_hoc = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ghi_chu = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    ngay_GQTC = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    nguoi_GQTC = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    quyet_dinh_thu_ly_GQTC = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ngay_QDGQTC = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    quyet_dinh_dinh_chi_GQTC = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    gia_han_GQTC_1 = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    gia_han_GQTC_2 = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    so_VB_KL_NDTC = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ngay_nhan_TB_KQXLKLTC = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ket_qua = table.Column<int>(type: "integer", nullable: true),
                    cong_khai = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UnitCode = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
